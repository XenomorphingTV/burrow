...
// Unknown names and empty strings fall back to Catppuccin Mocha.
...
// LoadThemeFile reads a TOML theme file. Unset fields retain the Catppuccin
// Mocha default, so partial theme files are valid.
